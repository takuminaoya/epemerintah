...
class KeluargaPolicy
{
    ...
    {
        return $user->can('delete_any_keluarga');
    }
    ...
    {
        return $user->can('force_delete_any_keluarga');
    }
    ...
    {
        return $user->can('restore_keluarga');
    }
    ...
    {
        return $user->can('restore_any_keluarga');
    }
    ...
    {
        return $user->can('replicate_keluarga');
    }
    ...
    {
        return $user->can('reorder_keluarga');
    }
}
